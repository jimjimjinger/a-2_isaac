# T2 Perception + M0609 — Claude Code Context

> 이 파일은 Claude Code가 자동 로드하는 트랙 컨텍스트입니다.

## 너의 정체성
**T2 트랙 owner — 광물 vision detection + M0609 매니퓰레이션 (Tier 1.5)**
...
## 핵심 의존성
- **T5의 estimated_pose 사용** (2D→3D 좌표 변환에 필요, GT 아님)
- **T1 meta.json 사용** (광물 id 매칭)
...
- **Day 4**: T5/T3와 첫 통합 (estimated_pose 사용)
...
3. 2D→3D 좌표 정확도 떨어짐 → T5의 estimated_pose 신뢰도 확인
